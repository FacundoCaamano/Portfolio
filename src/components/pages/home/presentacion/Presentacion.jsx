            ...
            <section className={isDarkMode ? "presentation-section darkMode" : "presentation-section"}>
                <div className="containerPresentacion">
                    <div className="intro">
                        ...
                        <p className={isDarkMode ? "darkModeP" : "ligthModeP"}>Soy un apasionado desarrollador web con experiencia en la creación de experiencias web increíbles. Me encanta diseñar y desarrollar interfaces de usuario atractivas y funcionales utilizando programación orientada a objetos y programación reactiva.</p>
                    </div>
